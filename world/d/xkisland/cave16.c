// Room: /u/dunno/cave/cave16.c
// /u/dan/room/cave/cave16.c
// dan
inherit ROOM;
...
LONG
	...
	set("exits", ([ /* sizeof() == 2 */
  "north" : __DIR__"cave15",
  "south" : __DIR__"cave17",
]));
