// Room: /u/dunno/cave/cave22.c
// /u/dan/room/cave/cave22.c
// dan
inherit ROOM;
...
LONG
	...
	set("exits", ([ /* sizeof() == 2 */
  "north" : __DIR__"cave21",
  "south" : __DIR__"cave23",
]));
...
int do_studywall()
{
	...
	message_vision("$N专心地研究墙壁上的图形。\n", me); 
        ...
        if ((int)me->query_skill("literate", 1) <= 0)
         ...
         if ((int)me->query_skill("sword", 1) <= 199
        ...
        if ((int)me->query_skill("sword", 1) <= 299
